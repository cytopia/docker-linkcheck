# Docker image for `linkcheck`

[![Tag](https://img.shields.io/github/tag/cytopia/docker-linkcheck.svg)](https://github.com/cytopia/docker-linkcheck/releases)
[![](https://img.shields.io/badge/github-cytopia%2Fdocker--linkcheck-red.svg)](https://github.com/cytopia/docker-linkcheck "github.com/cytopia/docker-linkcheck")
[![License](https://img.shields.io/badge/license-MIT-%233DA639.svg)](https://opensource.org/licenses/MIT)

[![lint](https://github.com/cytopia/docker-linkcheck/workflows/lint/badge.svg)](https://github.com/cytopia/docker-linkcheck/actions?query=workflow%3Alint)
[![build](https://github.com/cytopia/docker-linkcheck/workflows/build/badge.svg)](https://github.com/cytopia/docker-linkcheck/actions?query=workflow%3Abuild)
[![nightly](https://github.com/cytopia/docker-linkcheck/workflows/nightly/badge.svg)](https://github.com/cytopia/docker-linkcheck/actions?query=workflow%3Anightly)
...
View **[Dockerfiles](https://github.com/cytopia/docker-linkcheck/blob/master/Dockerfiles/)** on GitHub.


**Available Architectures:**  `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6`, `ppc64le`, `s390x`

Tiny Alpine-based multistage-build dockerized version of [linkcheck](https://github.com/cytopia/linkcheck)<sup>[1]</sup>.
The image is built nightly against multiple stable versions and pushed to Dockerhub.

<sup>[1] Official project: https://github.com/cytopia/linkcheck</sup>

## :whale: Available Docker image versions

[![](https://img.shields.io/docker/pulls/cytopia/linkcheck.svg)](https://hub.docker.com/r/cytopia/linkcheck)
[![Docker](https://badgen.net/badge/icon/:latest?icon=docker&label=cytopia/linkcheck)](https://hub.docker.com/r/cytopia/linkcheck)
...
| Docker Tag           | Git Ref   | linkcheck       | Available Architectures                      |
|----------------------|-----------|--------------|----------------------------------------------|
